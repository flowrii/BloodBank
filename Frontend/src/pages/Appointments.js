...
function Appointments() {
    ...
    async function getAppointmentsForDonor() {
        const userResponse=await api.get(`/api/Donors/username/${username}`);
        ...
        <div>
            ...
            {editingAppointment && (
                <div>
                    ...
                    <AppointmentForm appointment={editingAppointment} handleSubmit={handleEdit} handleCancel={handleCancel} />
                </div>
            )}
            <p> </p>
            {creatingAppointment && (
                <div>
                    ...
                    <AppointmentForm appointment={creatingAppointment} handleSubmit={handleCreate} handleCancel={handleCancel} />
                </div>
            )}
